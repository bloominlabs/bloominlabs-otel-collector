...
require (
	github.com/bloominlabs/baseplate-go/config/filesystem v0.0.0-20250111040505-c8dd9084f267
	github.com/hashicorp/nomad/api v0.0.0-20250117203833-44d9c2a3d1e1
