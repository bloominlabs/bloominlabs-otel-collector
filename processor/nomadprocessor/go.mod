...
require (
	github.com/bloominlabs/baseplate-go/config/filesystem v0.0.0-20240803090724-bfa5d7338da3
	github.com/hashicorp/nomad/api v0.0.0-20240809172804-b7419bc94015
