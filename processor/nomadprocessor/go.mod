...
require (
	github.com/bloominlabs/baseplate-go/config/filesystem v0.0.0-20240313230431-4283f10e640c
	github.com/hashicorp/nomad/api v0.0.0-20240318220323-4cc90c0b22e6
