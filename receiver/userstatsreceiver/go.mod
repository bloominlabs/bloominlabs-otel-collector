...
require (
	...
	github.com/bloominlabs/baseplate-go/config/spaces v0.0.0-20250111040505-c8dd9084f267
...
require (
	...
	github.com/bloominlabs/baseplate-go/config/env v0.0.0-20250111040505-c8dd9084f267 // indirect
