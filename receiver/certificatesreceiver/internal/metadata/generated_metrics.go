...
func (m *metricCertificatesCertExpiresInSeconds) recordDataPoint(start pcommon.Timestamp, ts pcommon.Timestamp, val int64, filenameAttributeValue string, hostNameAttributeValue string, cnAttributeValue string) {
	...
	dp.SetTimestamp(ts)
	dp.SetIntValue(val)
	dp.Attributes().PutStr("filename", filenameAttributeValue)
	dp.Attributes().PutStr("host.name", hostNameAttributeValue)
	dp.Attributes().PutStr("cn", cnAttributeValue)
}
...
func (mb *MetricsBuilder) EmitForResource(rmo ...ResourceMetricsOption) {
	...
	ils.Scope().SetName("github.com/open-telemetry/opentelemetry-collector-contrib/receiver/certificatesreceiver")
